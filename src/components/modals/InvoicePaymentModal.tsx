...
export const InvoicePaymentModal = ({ open, onOpenChange, invoice }: InvoicePaymentModalProps) => {
  const [selectedInvoices, setSelectedInvoices] = useState([invoice?.id]);
  ...
  const grossAmount = 35.19;
  const previousBalance = 213543.08;
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <p className="text-muted-foreground">
                        Dear <span className="text-foreground font-medium">vishal patel</span>,
                      </p>
                      <p className="text-sm text-muted-foreground">
                        We appreciate your prompt payment. Please complete the payment form below. Thanks for your business Developer vv
                      </p>
                    </div>
                    <div className="space-y-1 text-sm">
                      <p><span className="text-muted-foreground">From:</span> <span className="font-medium">Developer vv</span></p>
                      <p><span className="text-muted-foreground">Email:</span> vdeveloper@mybmr.com</p>
                      <p><span className="text-muted-foreground">Phone:</span> 8000260025</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                    ...
                    <table className="w-full">
                      <thead className="bg-muted/50 border-b">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-left font-semibold">Order Amount</th>
                      ...
                      <tbody>
                        <tr className="border-b hover:bg-muted/30">
                          ...
                          <td className="px-4 py-3 font-mono text-sm">{invoice.orderId}</td>
